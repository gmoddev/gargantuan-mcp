...
| Policy bypass/capability spoofing | Policy constructed only from local startup options; tool discovery intersected with negotiated adapter support; MCP metadata, requests, project data, and bridge results cannot elevate it |
